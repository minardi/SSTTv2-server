class SprintsController < ApplicationController
  ...
  def get_tasks_for_sprint
    ...
    @tasks = @project.sprints.each do |sprintitem|      
      sprintitem.stories.tasks.each do |taskitem|
        tasks_for_sprint.push(taskitem) 
      end                      
    end   
  end
  ...
  private
    ...
    def sprint_params
      params.require(:sprint).permit(:title, :description, :project_id, :start, :finish, :status)
    end
end
