...
class TeamMembersControllerTest < ActionController::TestCase
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post :create, team_member: { role: @team_member.role, team_id: @team_member.team_id, user_id: @team_member.user_id }
    end
  ...
  test "should update team_member" do
    patch :update, id: @team_member, team_member: { role: @team_member.role, team_id: @team_member.team_id, user_id: @team_member.user_id }
    assert_redirected_to team_member_path(assigns(:team_member))
  end
