...
class DashBoardsControllerTest < ActionController::TestCase
  ...
  test "should create dash_board" do
    assert_difference('DashBoard.count') do
      post :create, dash_board: { btn_content: @dash_board.btn_content, btn_type: @dash_board.btn_type, permission: @dash_board.permission }
    end
  ...
  test "should update dash_board" do
    patch :update, id: @dash_board, dash_board: { btn_content: @dash_board.btn_content, btn_type: @dash_board.btn_type, permission: @dash_board.permission }
    assert_redirected_to dash_board_path(assigns(:dash_board))
  end
